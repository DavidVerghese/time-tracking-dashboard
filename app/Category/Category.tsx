...
export default function Category({ category, timeframe, key }: CategoryProps) {
  ...
  const colorMap = {
    "tomato red": "bg-light-red-work",
    "blue": "bg-soft-blue-play",
    "cherry red": "bg-light-red-study",
    "green": "bg-lime-green-exercise ",
    "purple": "bg-violet-social",
    "green-brown": "bg-soft-orange-self-care",
  }
  ...
  const iconMap = {
    ...
    // ! Made the color darker here, from "#29BA66" to green
    Runner: (
    ...
    "Speech Bubble": (
      <svg width="75" height="100" xmlns="http://www.w3.org/2000/svg">
        <g fill="#5A1CBB" fillRule="nonzero">
  ...
  return (
    ...
    >
      <div className="mr-5 ml-auto h-1/5">{iconMap[category.icon]}</div>
